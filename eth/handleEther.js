...
exports.sendEther = async (addressTo, amount, privateKey, addressFrom) => {
    ...
    let gasPriceInWei = 6000000000;//new BigNumber(web3.utils.toWei(gasPrice.data.fastest.toString(), 'gwei'))
